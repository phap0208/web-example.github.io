...
<div id="carouselExampleIndicators" class="carousel slide " data-bs-ride="carousel" data-aos="fade-up">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= _PATH_IMG_PUBLIC . '/slide/QUAN-BAD SHOP 1.png ' ?>" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="<?= _PATH_IMG_PUBLIC . '/slide/QUAN-BAD SHOP 2.png' ?>" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="<?= _PATH_IMG_PUBLIC . '/slide/QUAN-BAD SHOP 3.png' ?>" class="d-block w-100" alt="...">
        </div>
    </div>
